...
data = HealthDataExtractor(
    path='E:/Documents/Predict_Ivan/Kaggle/raw_health_export.xml', 
    dest_path='E:/Documents/Predict_Ivan/Kaggle/')
data.report_stats()
data.extract();


entries = os.listdir('E:/Documents/Predict_Ivan/Kaggle/working/')
for entry in entries:
    
    try:
        data = pd.read_csv("E:/Documents/Predict_Ivan/Kaggle/working/" + entry,
                           index_col = "creationDate",
                           parse_dates = True,
                           dtype={"value": float})
        data["value"].plot(figsize = (10, 2), title = entry)
        plt.show()
    except:
        try:
            data = pd.read_csv("E:/Documents/Predict_Ivan/Kaggle/working/" + entry,
            ...
            data["duration"].plot(title = entry)
            plt.show()
        except:
            print("pass for " + entry)
            pass
```